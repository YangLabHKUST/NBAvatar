...
import importlib
import config
from network.fast_avatar import AvatarNet
...
class AvatarTrainer:
    ...
    def forward_one_pass_pretrain(self, items):
        ...
        positions, _ = self.avatar_net.get_geometry(pose_map, return_delta = True)
        opacities, scales, rotations, colors, _ = self.avatar_net.get_colors(pose_map, return_delta = True)
